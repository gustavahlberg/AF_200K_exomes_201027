...
h5readAttributes(h5.fn,"f.22006/f.22006")

h5readAttributes(h5.fn,"f.41280")
h5readAttributes(h5.fn,"f.41280/f.41280")

head(h5read(h5.fn,"f.22006/f.22006"))
head(h5read(h5.fn,"f.41280/f.41280")[,1:10])

df <- data.frame(sample.is = h5read(h5.fn,"sample.id"),
           eth = h5read(h5.fn,"f.22006/f.22006"),
           sex = h5read(h5.fn,"f.22006/f.22006"))
head(df)
