...
group_file <- paste0("../groupVariants_201117/groups/group_raremissense/set_raremissense_chr", chr, ".txt")
...
res_fn <- paste0("results/burden_smmat_raremissense_chr", chr, ".txt")
